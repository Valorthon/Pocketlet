...
| Claimable links — send to someone who has no wallet yet, via an escrow contract | **Broken** — creation returns 400 ([#149](https://github.com/Valorthon/Pocketlet/issues/149)), the deposit cannot be authorized ([#148](https://github.com/Valorthon/Pocketlet/issues/148)), claiming returns 500 ([#135](https://github.com/Valorthon/Pocketlet/issues/135)), and there is no refund UI. Being fixed; see [production-readiness](./docs/production-readiness.md) |
